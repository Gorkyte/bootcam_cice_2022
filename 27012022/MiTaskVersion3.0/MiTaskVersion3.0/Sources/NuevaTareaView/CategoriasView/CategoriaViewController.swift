...
class CategoriaViewController: UIViewController {
    ...
    let datasourceCategorias = ["Sin categoria", "Tienda de Apple", "Bar con los amigos", "En la librería", "En el Corte Inglés", "En el Mercadona", "En Casa", "En el Parque", "Peluquería", "En el trabajo"]
