    ...
    var body: some View {
        VStack(alignment: .center, spacing: 20){
            ...
            Text("Hola Mundo")
                    .font(.title)
            Button {
                // Aquí es en donde se captura la acción del botón
            } label: {
                HStack{
    ...
    var body: some View {
        VStack(spacing: 20){
            ...
            Text("Se puede meter shapes para decorar las vistas")
                ...
                .padding(8)
            Text("Se puede ajustar el fondo pero No con una Shape")
                .foregroundColor(.orange)
                .padding(10)
        ...
        ScrollView(.vertical, showsIndicators: true){
            VStack(spacing: 20){
                ...
                VStack(alignment: .leading, spacing: 10) {
                    Text("VStack dentro d otra Vstack")
...
struct AlignementHStackView: View{
    var body: some View{
        VStack(spacing:20){
            HeaderComponentes()
        ...
        VStack{
            HStack{
                ...
                Image("user1")
                    ...
                    .clipShape(Circle())
                Text("Equilibrio de la vista y más texto que tenemos que tener")
                    .font(.title2)
                    .lineLimit(2)
                    .layoutPriority(1)
            }
...
struct BasicChangedCircle: View {
    ...
    @State private var change = false // palabra reservada @State para poder cambiarla
...
struct CurvesAnimationsView: View{
    ...
    var body: some View {
        VStack(spacing: 20){
            ...
            Group{
                Text("1")
                GeometryReader{ proxy in // igual que si hicieramos un Spacer
                    Circle()
...
struct CurvesAnimationViewDos: View {
...
struct MenuAnimationView: View {
    ...
    @State private var showButton1 = false  // 0x000010 Write and Read
    @State private var showButton2 = false  // 0x000010 Write and Read
    @State private var showButton3 = false  // 0x000010 Write and Read
            ...
            ZStack(alignment: .bottomTrailing) {
                ...
                Group {
                    NavigationLink(isActive: self.$showButton1){
                        ...
                        Text("")// Esto le hace volver al 1er punto
                    }
                }
                Group {
                    NavigationLink(isActive: self.$showButton2){
                        Text("bad.badge.plus2")
                    } label: {
                        Text("")
                    }
                }
